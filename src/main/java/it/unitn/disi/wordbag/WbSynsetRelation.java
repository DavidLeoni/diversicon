 ...
 * @since 0.1
 */
public class WbSynsetRelation extends SynsetRelation {
	 ...
	 */
	public WbSynsetRelation(SynsetRelation sr) {
	 ...
	 * {@link it.unitn.disi.wordbag.Wordbag#SMATCH_UBY_URL
    ...
    public String toString() {
        ...
        return "WBSynsetRelation [depth=" + depth + ", provenance=" + provenance + ", source=" + sourceId + ", target="
