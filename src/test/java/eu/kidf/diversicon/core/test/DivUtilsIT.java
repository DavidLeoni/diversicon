...
public class DivUtilsIT {
    ...
    public void testFetchH2Db() {
        ...
        Path cacheRoot = Paths.get(DivTester.createTestDir()
                                            .toString(),
                "test");

        assertFalse(cacheRoot.toFile()
                             .exists());
        Diversicons.fetchH2Db(cacheRoot.toFile(), DivWn31.NAME, DivWn31.of()
                                                                       .getVersion());
        assertTrue(Diversicons.getCachedH2DbDir(cacheRoot.toFile(), DivWn31.NAME, DivWn31.of()
                                                                                         .getVersion())
                              .exists());
        // should be faster ...
